<?php
	...
	define("SUPPLIER_PERSON_REQ_TBL","os__supplier_persons_for_requisites"); 				// таблица должностей для лиц емеющих право подписи
	define("SUPPLIER_REQUISITES_TBL","os__supplier_requisites"); 							// таблица реквизитов клиентов
	define("SUPPLIER_REQUISITES_MANAGMENT_FACES_TBL","os__supplier_requisites_management");	// таблица лиц (контрагентов) имеющих право подписи
...
//	define("INVOICES_TBL2","os__invoices_for_pay2"); 										// таблица счетов
	...
	$suppliers_data_by_prefix = array(
		15 => array('name'=>'интерпрезент','link'=>'http://www.happygifts.ru/catalog_new/search/?q='),
		...
		'e_'=> array('name'=>'ебазар','link'=>'http://ebazaar.ru/catalog/?q='),
		'm_' => array('name'=>'', 'link'=>'#'),
		'FF' => array('name'=>'Апельбург', 'link'=>'#')
	);
									   
	//
	$print_mode_names = array(
		'tampoo' => 'тампопечать',
