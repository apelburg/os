	...
	var methods = {
		...
		init : function( options ) {
			...
			return this.each(function(){
				...
				// console.log(methods.mainObj)$(this).find('.js-js-variant_services_json div').html()
		...
		add_services:function( id_s ){
			...
			// // добавляем услуги в главный объект
			// for(var i = 0, length1 = new_services.length; i < length1; i++){
			// 	console.log()
			// 	methods.mainObj[new_services[i].dop_row_id][services][methods.mainObj[new_services[i].dop_row_id][services].length] = 
			// }
