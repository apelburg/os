...
<table class="client_form_table" style="margin-top:15px;">
  ...
  <tr>
    ...
    <td width="23%">
       ...
       <input id="" type="hidden" name="client_id" value="<?php echo $supplier_id; ?>">
...
$this->edit_requsits_show_person_all($this->edit_requsits_show_person($requesit['id']),$supplier_id);?>
</div>
<!-- разделитель --><div class="div_between_form_rows"></div><!-- // разделитель -->
