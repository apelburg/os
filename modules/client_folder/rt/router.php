<?php
	...
	*/
    ...
    if(isset($_GET['change_quantity_and_calculators'])){
		...
		// что этот калькулятор автоматический записать в эти поля новые значения стоимости, а также записать в них значение 
		// need_confirmation в случае если тип калькуляторов "ручной" и "Дежурная услуга"
